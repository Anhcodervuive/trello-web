...
// import { ReactComponent as PlanetSvg } from '~/assets/404/planet.svg?react'
// import { ReactComponent as AstronautSvg } from '~/assets/404/astronaut.svg?react'
import astronaut from '~/assets/404/astronaut.svg'
import planet from '~/assets/404/planet.svg'
      ...
      <Box sx={{
        ...
        <Box sx={{ width: '390px', height: '390px', position: 'relative' }}>
          <SvgIcon inheritViewBox sx={{
            ...
            <image href={astronaut} width="100%" height="100%" />
          </SvgIcon>
          ...
          <SvgIcon inheritViewBox sx={{
            ...
            <image href={planet} width="100%" height="100%" />
          </SvgIcon>
        </Box>
